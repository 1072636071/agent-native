      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-3 text-sm">
          <span className="font-medium text-foreground/70">
            {meal.calories} {t("macros.mealCard.kcal")}
          </span>
          {((meal.protein ?? 0) > 0 ||
            (meal.carbs ?? 0) > 0 ||
            (meal.fat ?? 0) > 0) && (
      ...
      <div className="flex gap-0.5 md:opacity-0 md:group-hover:opacity-100">
        {isPending ? (
          <div
            ...
            aria-label={t("macros.mealCard.savingMeal")}
          >
          ...
          <>
            <Button
              variant="ghost"
              size="icon"
              aria-label={t("macros.mealCard.editMeal", { name: meal.name })}
            ...
            <Button
              variant="ghost"
              size="icon"
              aria-label={t("macros.mealCard.deleteMeal", { name: meal.name })}
